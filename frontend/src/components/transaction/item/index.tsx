...
export default function TransactionItem({
  ...
  const category = getExpenseCategory(transaction, categories)

  async function handleDeleteClick(
    event: React.MouseEvent<HTMLButtonElement>
  ) {
    const data = await deleteExpense(transaction.id)
  ...
  function handleUpdateClick() {
    showEditModal('expense', transaction.frequency, transaction)
  }
